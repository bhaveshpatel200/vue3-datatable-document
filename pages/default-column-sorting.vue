<template>
  <div>
    <div class="flex items-center justify-between mb-5">
      <h2 class="text-3xl">Default column sorting</h2>
      <a
        href="#code-preview"
    ...
    <vue3-datatable :rows="rows" :columns="cols" :totalRows="rows?.length" :sortable="true" sortDirection="asc" sortColumn="firstName">
    </vue3-datatable>
...
&lt;!-- html --&gt;
&lt;template&gt;
  &lt;vue3-datatable :rows=&quot;rows&quot; :columns=&quot;cols&quot; :totalRows=&quot;rows?.length&quot; :sortable=&quot;true&quot; sortDirection=&quot;asc&quot;&gt;
  &lt;/vue3-datatable&gt;
&lt;/template&gt;
</pre>
      </Highlight>
