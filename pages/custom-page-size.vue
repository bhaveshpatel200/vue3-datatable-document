<template>
  <div>
    ...
    <vue3-datatable :rows="rows" :columns="cols" :totalRows="rows?.length" :pageSizeOptions="[10, 50, 100]" paginationInfo="Displaying {0} to {1} of {2} items">
    </vue3-datatable>
...
&lt;template&gt;
  &lt;vue3-datatable
      ...
      paginationInfo=&quot;Displaying {0} to {1} of {2} items&quot;
  &gt;
  &lt;/vue3-datatable&gt;
&lt;/template&gt;
</pre
